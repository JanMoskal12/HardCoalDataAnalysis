...
```{r}
plot(dane, main = "Ceny węgla kamiennego", lwd = 2, type = "l", xlab = "Czas", ylab = "zł")
wykładnicza(dane, 0.9, "red")
wykładnicza(dane, 0.7, "blue")
wykładnicza(dane, 0.5, "green")
wykładnicza(dane, 0.3, "purple")
```

W celu elminacji losowych fluktuacji w szergeu czasowym użyliśmy metody wykładniczych wag ruchomej średniej. Widać, że wraz ze wzrostem współczynnika wag funkcja przybliżająca mniej naśladuje zaburzenia zewnętrzne w modelu i na odwrót. 
...
Za pomocą różnicowania pierwszego stopnia pozbyliśmy się niestacjonarności z naszego szeregu.
Oryginalny szereg był niestacjonarny, ale zróżnicowanie usunęło trend lub inne niestacjonarne komponenty, takie jak zmienność w średniej lub sezonowość. różnicowanie pierwszego rzędu było wystarczające, oznacza to, że szereg ma jeden pierwiastek jednostkowy.